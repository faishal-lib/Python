...
def update_data(db):
    cursor = db.cursor()
    show_data(db)
    id_penjualan = input("Pilih ID Penjualan : ")
    ...
    val = (id_pegawai, id_barang, kuantitas, harga_satuan, jumlah, id_penjualan)
    cursor.execute(sql, val)
    db.commit()
